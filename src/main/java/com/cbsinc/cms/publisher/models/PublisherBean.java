 ...
 */
@Component
public class PublisherBean extends WebControls implements java.io.Serializable {
	...
	private XLogger log = XLoggerFactory.getXLogger(PublisherBean.class.getName());
