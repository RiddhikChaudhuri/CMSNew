 ...
 */
@Component 
public class CalendarEditBean extends WebControls implements java.io.Serializable {

	private static final long serialVersionUID = 8381891800819464179L;

	
	private XLogger logger = XLoggerFactory.getXLogger(CalendarEditBean.class.getName());
    ...
    public void editCalendar() {
      ...
      String query = "";
      query = "update calendar set soft_id = " + product_id + " , holddate = " + holddate
