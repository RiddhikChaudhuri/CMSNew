...
public class Ext2ProductPostUserAction extends CMSObjects{
  ...
  @PostMapping("/doPostUserExt2Product")
  ...
  @GetMapping("/doGetUserExt2Product")
	public CMSExtProductPageModel doGet(@RequestBody Ext2ProductRequest ext2ProductRequest)throws Exception {
		action(ext2ProductRequest);
		PublisherBean publisherBeanId = getPublisherBean().get();
        AuthorizationPageBean authorizationPageBeanId = getAuthorizationPageBean().get();
