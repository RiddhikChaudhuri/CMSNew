...
public class ProductUserPostRealtyAction extends CMSObjects {

  private XLogger logger = XLoggerFactory.getXLogger(ProductUserPostRealtyAction.class.getName());
	...
	public ProductUserPostRealtyAction() {
	  logger.entry();
	  logger.exit();
	}

    @PostMapping(value="/doPostProductUserRealty",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Post For Product User Realty Action Controller",notes = "Returns Product User Realty Action Controller based on the Request")
	public @ResponseBody CMSNewBlockPostCreResponseModel doPost(@RequestBody  ProductPostCreForm productListWebForm)throws Exception {
		...
		if (productListWebForm.getGen_number() != null) {
			...
			authorizationPageBeanId.setStrMessage(
					authorizationPageBeanId.getLocalization(getServletContext()).getString("wrong_gen_number"));
		}
    ...
    @GetMapping(value="/doGetProductUserRealty",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Get for Product User Realty Action Controller",notes = "Get For Product User Realty Action controller Based on Product ID")
