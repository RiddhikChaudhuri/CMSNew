...
public class ExtFilesProductPostAction extends CMSObjects{

  private XLogger logger = XLoggerFactory.getXLogger(ExtFilesProductPostAction.class.getName());
  ...
  public ExtFilesProductPostAction() {
    logger.entry();
    logger.exit();
  }


  @PostMapping("/doPostPageExtFilesProduct")
  public CMSExtProductPageModel doPost(@RequestBody ExtFilesProductRequest extFilesProductRequest)throws Exception {
    ...
    @GetMapping("/doGetPageExtFilesProduct")
	public CMSExtProductPageModel doGet(@RequestBody ExtFilesProductRequest extFilesProductRequest)
			throws Exception {
        logger.entry(extFilesProductRequest);
	...
	void action(ExtFilesProductRequest extFilesProductRequest)throws Exception {
