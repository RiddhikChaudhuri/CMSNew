...
public class ProductUserPostVideoAction extends CMSObjects {
  ...
  private XLogger logger = XLoggerFactory.getXLogger(ProductUserPostRealtyAction.class.getName());
	...
	public ProductUserPostVideoAction() {
      logger.entry();
      logger.exit();
    }

    @PostMapping(value="/doPostProductUserVideo",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value="/doGetProductUserVideo",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
