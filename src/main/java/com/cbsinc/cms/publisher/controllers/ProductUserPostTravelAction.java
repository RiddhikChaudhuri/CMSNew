...
@RestController
public class ProductUserPostTravelAction extends CMSObjects {

  private XLogger logger = XLoggerFactory.getXLogger(ProductUserPostTravelAction.class.getName());
    ...
    public ProductUserPostTravelAction() {
      logger.entry();
      logger.exit();
    }

	@PostMapping(value="/doPostProductUserPosTravel",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Post For Product User Travel Action Controller",notes = "Returns Product User Travel Action Controller based on the Request")
	...
	@GetMapping(value="/doGetProductUserPosTravel",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Get For Product User Travel Action Controller",notes = "Returns Product User Travel Action Controller based on the Request")
