...
public class ProductUserPostTransportAction extends CMSObjects {

  
  private XLogger logger = XLoggerFactory.getXLogger(ProductUserPostTransportAction.class.getName());
    ...
    public ProductUserPostTransportAction() {
      logger.entry();
      logger.exit();
    }

    @PostMapping(value="/doPostProductUserPostTransport",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Post For Product User Transport Controller",notes = "Returns Product User Transport Controller based on the Request")
    ...
    @GetMapping(value="/doGetProductUserPostTransport",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Post For Product User Transport Controller",notes = "Returns Product User Transport Controller based on the Request")
