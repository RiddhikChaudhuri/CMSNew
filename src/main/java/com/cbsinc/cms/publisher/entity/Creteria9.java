...
@Entity
@Table(name="creteria9")
public class Creteria9 implements java.io.Serializable {

    @Id
    @Column(name="CRETERIA9_ID")
	...
	public Creteria9(long creteria9Id, long linkId, long catalogId) {
		this.creteria9Id = creteria9Id;
		this.linkId = linkId;
		this.catalogId = catalogId;
	}

	public Creteria9(long creteria9Id, String name, Boolean active,
