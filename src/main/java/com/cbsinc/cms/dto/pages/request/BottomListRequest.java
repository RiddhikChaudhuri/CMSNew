...
public class BottomListRequest {
	...
	public String toString() {
		return "BottomListRequest [action=" + action + ", bigimage_id=" + bigimage_id + ", image_id=" + image_id
				+ ", product_id=" + product_id + ", parent_id=" + parent_id + ", type_id=" + type_id + ", row=" + row
				+ ", del=" + del + ", offset=" + offset + ", insert=" + insert + ", creteria1_id=" + creteria1_id
				+ ", creteria2_id=" + creteria2_id + ", creteria3_id=" + creteria3_id + ", creteria4_id=" + creteria4_id
				+ ", creteria5_id=" + creteria5_id + ", creteria6_id=" + creteria6_id + ", creteria7_id=" + creteria7_id
				+ ", creteria8_id=" + creteria8_id + ", creteria9_id=" + creteria9_id + ", creteria10_id="
				+ creteria10_id + ", softname=" + softname + ", catalog_id=" + catalog_id + ", softcost=" + softcost
