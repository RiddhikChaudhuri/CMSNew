...
public class Co1ProductRequest {
	...
	public String toString() {
		return "Co1ProductRequest [action=" + action + ", name=" + name + ", catalog_id=" + catalog_id + ", row=" + row
				+ ", bigimage_id=" + bigimage_id + ", image_id=" + image_id + ", parent_id=" + parent_id
				+ ", creteria1_id=" + creteria1_id + ", creteria2_id=" + creteria2_id + ", creteria3_id=" + creteria3_id
				+ ", creteria4_id=" + creteria4_id + ", creteria5_id=" + creteria5_id + ", creteria6_id=" + creteria6_id
				+ ", creteria7_id=" + creteria7_id + ", creteria8_id=" + creteria8_id + ", creteria9_id=" + creteria9_id
				+ ", creteria10_id=" + creteria10_id + ", del=" + del + ", offset=" + offset + ", insert=" + insert
				+ ", softname=" + softname + ", softcost=" + softcost + ", currency_id=" + currency_id
				+ ", description=" + description + ", fulldescription=" + fulldescription + ", imagename=" + imagename
				+ ", portlettype_id=" + portlettype_id + ", filename=" + filename + ", bigimagename=" + bigimagename
				+ ", type_id=" + type_id + ", salelogic_id=" + salelogic_id + ", product_id=" + product_id + "]";
	}
