...
public class CMSBottomListProductResponseDTO extends PageModel {
  ...
  public CMSBottomListProductResponseDTO(PublisherBean publisherBeanId,AuthorizationPageBean authorizationPageBeanId,CatalogListBean catalogListBeanId) {
