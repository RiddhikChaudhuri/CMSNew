...
public class ProductUserPostWithoutCatalogRequestForm {

	@JsonProperty("gen_number")
	private String gen_number;
	...
	public String toString() {
		return "ProductUserPostWithoutCatalogRequestForm [gen_number=" + gen_number + ", bigimage_id=" + bigimage_id
				+ ", image_id=" + image_id + ", product_id=" + product_id + ", parent_id=" + parent_id + ", row=" + row
				+ ", del=" + del + ", offset=" + offset + ", creteria1_id=" + creteria1_id + ", creteria2_id="
				+ creteria2_id + ", creteria3_id=" + creteria3_id + ", creteria4_id=" + creteria4_id + ", creteria5_id="
				+ creteria5_id + ", creteria6_id=" + creteria6_id + ", creteria7_id=" + creteria7_id + ", creteria8_id="
				+ creteria8_id + ", creteria9_id=" + creteria9_id + ", creteria10_id=" + creteria10_id + ", softname="
				+ softname + ", catalog_id=" + catalog_id + ", softcost=" + softcost + ", currency_id=" + currency_id
				+ ", description=" + description + ", fulldescription=" + fulldescription + ", imagename=" + imagename
				+ ", filename=" + filename + ", bigimagename=" + bigimagename + ", portlettype_id=" + portlettype_id
				+ ", salelogic_id=" + salelogic_id + "]";
	}
