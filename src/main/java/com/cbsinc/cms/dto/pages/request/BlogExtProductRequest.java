...
public class BlogExtProductRequest {
	...
	public String toString() {
		return "BlogExtProductRequest [gen_number=" + gen_number + ", bigimage_id=" + bigimage_id + ", image_id="
				+ image_id + ", product_id=" + product_id + ", softname=" + softname + ", catalog_id=" + catalog_id
				+ ", type_id=" + type_id + ", softcost=" + softcost + ", currency_id=" + currency_id + ", description="
				+ description + ", fulldescription=" + fulldescription + ", imagename=" + imagename
